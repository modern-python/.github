...
- [`that-depends`](https://github.com/modern-python/that-depends) — simple DI framework for Python;
...
Projects in this organization are built with [`uv`](https://github.com/astral-sh/uv) (package and project manager), [`ruff`](https://github.com/astral-sh/ruff) (linter and formatter), and [`ty`](https://github.com/astral-sh/ty) (type checker).
