...
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-project-marks-single-gold-inner.md
│   └── 0002-discussions-is-the-only-owned-channel.md
└── brand/
```
...
> _Contradicts ADR-0001 (project marks single gold inner), but worth reopening because…_
